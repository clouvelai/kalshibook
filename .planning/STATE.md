...
4. **Pre-populate playground with real captured market data** (dashboard) — Example ticker returns 404; need a real market/timestamp so "Try an example" works out of the box.
